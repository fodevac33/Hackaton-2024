...
export class InternetFight extends Scene {
  ...
  timeLeft: number = 60; // 60 seconds countdown
  ...
  preload() {
    ...
    this.load.audio("music_internet", "audio/eek.mp3");

    this.load.image("back_internet", "image/background.jpg");
  ...
  spawnProjectile() {
    ...
    projectile.body.setSize(projectile.width * 0.6, projectile.height * 0.4);
